...
#: exceptions.py:84
msgid "Malformed self."
msgstr "Malformed self."
...
#: exceptions.py:120
msgid "Could not satisfy the self Accept header."
msgstr "Could not satisfy the self Accept header."

#: exceptions.py:132
msgid "Unsupported media type \"{media_type}\" in self."
msgstr "Unsupported media type \"{media_type}\" in self."
